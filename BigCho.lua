...
module("Chogath", package.seeall, log.setup)
clean.module("Chogath", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/BigChogath.lua", "1.0.6")
