...
module("Garen", package.seeall, log.setup)
clean.module("Garen", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/BigGaren.lua", "1.0.6")
