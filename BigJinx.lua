...
module("Jinx", package.seeall, log.setup)
clean.module("Jinx", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/BigJinx.lua", "1.3.7")
