...
module("Mordekaiser", package.seeall, log.setup)
clean.module("Mordekaiser", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/BigMordekaiser.lua", "1.0.2")
