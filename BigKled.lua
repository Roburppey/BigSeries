if Player.CharName ~= "Kled" then return end

module("Kled", package.seeall, log.setup)
clean.module("Kled", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/BigKled.lua", "1.1.1")
