if Player.CharName ~= "Veigar" then return end

module("Veigar", package.seeall, log.setup)
clean.module("Veigar", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/BigVeigar.lua", "1.1.1")
