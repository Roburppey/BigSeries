...
module("BigSeries TwistedFate", package.seeall, log.setup)
clean.module("BigSeries TwistedFate", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/Roburppey/Public/main/BigTwistedFate.lua", "1.1.1")
