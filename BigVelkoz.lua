if Player.CharName ~= "Velkoz" then return end

module("Velkoz", package.seeall, log.setup)
clean.module("Velkoz", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/BigVelkoz.lua", "1.0.2")
