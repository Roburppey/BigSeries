...
module("BigSeries Brand", package.seeall, log.setup)
clean.module("BigSeries Brand", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/Roburppey/Public/main/BigBrand.lua", "1.1.3")
