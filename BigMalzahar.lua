if Player.CharName ~= "Malzahar" then return end

module("Malzahar", package.seeall, log.setup)
clean.module("Malzahar", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/BigMalzahar.lua", "1.1.4")
