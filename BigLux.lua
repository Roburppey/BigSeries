...
module("BigSeries Lux", package.seeall, log.setup)
clean.module("BigSeries Lux", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/Roburppey/Public/main/BigLux.lua", "1.2.9")
