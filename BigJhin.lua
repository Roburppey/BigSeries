if Player.CharName ~= "Jhin" then return end

module("Jhin", package.seeall, log.setup)
clean.module("Jhin", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/BigJhin.lua", "1.2.2")
